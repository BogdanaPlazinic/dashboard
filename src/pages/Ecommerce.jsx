...
import { earningData, SparklineAreaData, ecomPieChartData, dashboardBg } from '../data/dummy';
        ...
        <div className=' mt-12'>
            <div className=' flex flex-wrap lg:flex-nowrap justify-center'>
                <div className=" bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl
                 w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-contain bg-center">
                    <div className=' flex justify-between items-center'>
                        <div>
                            <p className=' font-bold text-gray-400'>Earnings</p>
                            <p className=' text-2xl'>$631,256,527</p>
                        </div>
                    </div>
                ...
                <div className='flex flex-wrap justify-center items-center m-3 space-x-2 space-y-2'>
