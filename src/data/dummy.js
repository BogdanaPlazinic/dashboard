...
export const EditorData = () => (
  <div>
    ...
    Malesuada fames ac turpis egestas sed. Quis vel eros donec ac odio tempor orci. Etiam dignissim diam quis enim lobortis scelerisque fermentum. 
    Consectetur libero id faucibus nisl tincidunt eget. Aliquam vestibulum morbi blandit cursus risus at ultrices. Massa massa ultricies mi quis hendrerit dolor magna. 
    Nibh ipsum consequat nisl vel pretium. Vulputate enim nulla aliquet porttitor. Posuere ac ut consequat semper viverra nam libero justo laoreet.

    Aenean vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant. Commodo quis imperdiet massa tincidunt nunc. Accumsan tortor posuere ac ut consequat semper. 
    Mollis aliquam ut porttitor leo a. Donec et odio pellentesque diam volutpat commodo sed egestas. Leo duis ut diam quam nulla porttitor massa. Quis viverra nibh cras pulvinar mattis nunc. 
    Maecenas accumsan lacus vel facilisis volutpat est. Pretium quam vulputate dignissim suspendisse in est ante in. Rhoncus aenean vel elit scelerisque mauris. 
    Diam maecenas sed enim ut sem viverra aliquet. Lobortis mattis aliquam faucibus purus in massa tempor nec feugiat. 
    Ipsum suspendisse ultrices gravida dictum fusce ut placerat orci nulla. Volutpat diam ut venenatis tellus in metus. Quam id leo in vitae turpis massa sed.

    Amet consectetur adipiscing elit ut aliquam purus sit. Non blandit massa enim nec. Lorem sed risus ultricies tristique. 
    Dictum non consectetur a erat nam at lectus urna. Et tortor at risus viverra adipiscing at in. Nunc consequat interdum varius sit amet mattis vulputate enim. 
    Turpis massa sed elementum tempus egestas sed sed risus. Ipsum consequat nisl vel pretium lectus. Aliquet nibh praesent tristique magna sit amet purus gravida. 
    Odio euismod lacinia at quis risus sed vulputate odio. Consequat mauris nunc congue nisi vitae. Ultrices sagittis orci a scelerisque purus semper eget duis at. 
    Sed nisi lacus sed viverra tellus in hac habitasse. Aliquet porttitor lacus luctus accumsan tortor posuere ac.
    </h3>
  </div>
);
...
export const ordersData = [
  ...
  {
    OrderID: 345653,
    CustomerName: 'KitchenAid Mixer',
    TotalAmount: 56.34,
    OrderItems: 'KitchenAid Mixer',
    Location: 'Delhi',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ProductImage:
  ...
  {
    OrderID: 390457,
    CustomerName: 'KitchenAid Blender',
    TotalAmount: 93.31,
    OrderItems: 'KitchenAid Blender',
    Location: 'New York',
    Status: 'active',
...
export const PyramidData = [
  { x: 'Ovens', y: 85.255, text: '$85.255' },
  { x: 'Freezers', y: 110.574, text: '$110.574' },
  { x: 'Outdoor Grill', y: 428.211, text: '$428.211' },
  { x: 'Refrigerators', y: 688.414, text: '$688.414' },
  { x: 'Vacuum cleaners', y: 989.263, text: '$1.125.625' },
  { x: 'Small kitchen appliances', y: 999.362, text: '$1.785.255' },
];
